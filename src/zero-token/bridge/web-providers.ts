...
type ModelsConfigNonNull = NonNullable<OpenClawConfig["models"]>;
type ProviderConfig = NonNullable<ModelsConfigNonNull["providers"]>[string];
...
export const SAKANA_WEB_BASE_URL = "https://chat.sakana.ai";
const SAKANA_WEB_DEFAULT_COST = { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 };
const SAKANA_WEB_DEFAULT_CONTEXT_WINDOW = 32000;
const SAKANA_WEB_DEFAULT_MAX_TOKENS = 4096;

export function buildSakanaWebProvider(_params?: {
  _?: never;
  apiKey?: string;
}): ProviderConfig {
  return {
    baseUrl: SAKANA_WEB_BASE_URL,
    api: "sakana-web",
    models: [
      {
        id: "namazu",
